...
[CreateAssetMenu(fileName = "LaserRangedAttack", menuName = "ScriptableObjects/Attacks/PlayerAttacks/WeaponAttacks/LaserRangedAttack")]
public class LaserRangedAttack : WeaponAttack
{
    ...
    public override IEnumerator Activate(ButtonInput button = ButtonInput.Fire)
    {
        ...
        */
        ...
        Projectile proj = weapon.FireLaserProjectile();

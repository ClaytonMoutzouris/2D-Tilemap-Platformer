...
[CreateAssetMenu(fileName = "ChargeThrownAttack", menuName = "ScriptableObjects/Attacks/PlayerAttacks/WeaponAttacks/ChargeThrownAttack")]
public class ChargeThrownAttack : WeaponAttack
{
    ...
    public override IEnumerator Activate(ButtonInput button = ButtonInput.LightAttack)
    {
        ...
        if (chargeMultiplier > 1)
        {
            ...
            projectileSpeedBonus = new WeaponAttributeBonus(WeaponAttributesType.ProjectileSpeed, chargeMultiplier, StatModType.Multiplier);

            weapon.weaponAttributes.AddBonus(projectileSpeedBonus);
        ...
        weapon.weaponAttributes.RemoveBonus(projectileSpeedBonus);

...
public class AttackObject : MonoBehaviour
{
    ...
    public virtual void CollisionedWith(Collider2D collider)
    {
        ...
        {
            if(hurtbox.owner.CheckHit(this))
            {
    ...
    public virtual AttackHitData HitEnemy(IHurtable hit)
    {

        //We should really only generate this when we hit something with Health
        ...
        if(hit == null || hit.GetEntity() == null || hit.GetEntity().isDead)
        {
